        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="bg-white p-8 shadow-sm rounded-2xl text-center">
              ...
              <p className="italic text-gray-500 mt-4 text-sm font-medium">"{friend.bio}"</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white p-6 shadow-sm rounded-xl text-center border border-gray-100">
                <h4 className="text-2xl font-bold text-[#244d3f]">{friend.days_since_contact}</h4>
                <p className="text-[#64748B] text-xs mt-1 uppercase tracking-wide">Days Since Contact</p>
              </div>
              <div className="bg-white p-6 shadow-sm rounded-xl text-center border border-gray-100">
                <h4 className="text-2xl font-bold text-[#244d3f] ">30</h4>
                <p className="text-[#64748B] text-xs mt-1 uppercase tracking-wide">Goal (Days)</p>
              </div>
              <div className="bg-white p-6 shadow-sm rounded-xl text-center border border-gray-100">
                <h4 className="text-3xl font-bold text-[#244d3f]">22 April 2026</h4>
                <p className="text-[#64748B] text-xs mt-1 uppercase tracking-wide">Next Due</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 shadow-sm rounded-xl border border-gray-100 flex justify-between items-center">
              <div>
                <h4 className="font-bold text-emerald-800 text-lg">Relationship Goal</h4>
                <p className="text-gray-500 text-sm mt-1">Connect every <span className="font-bold text-gray-800">30 days</span></p>
              </div>
              <button className="bg-gray-50 px-4 py-1.5 rounded-lg text-sm font-medium border border-gray-200 text-gray-600 hover:bg-gray-100">Edit</button>
            </div>

            {/* Quick Check-In Card */}
            <div className="bg-white p-6 shadow-sm rounded-xl border border-gray-100">
              <h4 className="font-bold text-emerald-800 text-lg mb-6">Quick Check-In</h4>
